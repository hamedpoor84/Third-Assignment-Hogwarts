...
public class Teacher extends Account
{
    ...
    public void Take_Courses(Course course , Teacher teacher)
    {
    ...
    public void Score_Students(){
        ...
        int choose_course = Integer.valueOf(myObj.nextLine());  // Read user input
        ...
        int score = Integer.valueOf(myObj.nextLine());
